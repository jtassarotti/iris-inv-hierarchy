...
Lemma twp_value_fupd' s E Φ v : WP of_val v @ s; E [{ Φ }] ⊣⊢ |NC={E}=> Φ v.
...
Proof.
  ...
  iIntros (σ1 ns κs nt) "Hσ". iMod (ncfupd_mask_subseteq E1) as "Hclose"; first done.
  iMod ("IH" with "[$]") as "[% IH]".
...
Lemma twp_value_fupd s E Φ e v : IntoVal e v → WP e @ s; E [{ Φ }] ⊣⊢ |NC={E}=> Φ v.
